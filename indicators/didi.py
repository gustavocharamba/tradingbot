...
def __getDidi__(history, short, long, ref):
    ...
    didi_buy_conf = ((short_line > short_line.shift(1)) & (long_line < long_line.shift(1)) & (short_line > ref_line))
    didi_sell_conf = (long_line > long_line.shift(1)) & (long_line > short_line) & (long_line < ref_line)
